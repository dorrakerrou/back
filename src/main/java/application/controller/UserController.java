...
public class UserController {
    ...
    @RequestMapping(value ="/getNomPrenom", method = RequestMethod.GET)
	public Utilisateur getNomPrenom(@RequestParam(name="cin",defaultValue="")String cin)
	{
		return userService.getNomPrenom(cin) ; 
	}
